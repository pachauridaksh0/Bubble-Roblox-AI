        ...
        <AnimatePresence>
            {isOpen && (
                ...
                >
                    ...
                    <div className="p-2">
                         <button onClick={handleSwitchToAuto} className="w-full flex items-center gap-3 px-3 py-2 text-sm text-gray-200 rounded-md hover:bg-white/10 hover:text-white transition-colors">
                            <SparklesIconSolid className="w-5 h-5" />
                            <span>Autonomous Mode</span>
                        </button>
                        <button onClick={handleSwitchToCocreator} className="w-full flex items-center gap-3 px-3 py-2 text-sm text-gray-200 rounded-md hover:bg-white/10 hover:text-white transition-colors">
